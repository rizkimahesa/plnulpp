    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:justify-center flex-1 space-x-6">
                <a href="{{ route('user.dashboard') }}" class="text-white hover:underline underline-offset-4 decoration-2 decoration-indigo-500 px-3 py-2 text-sm font-medium">
                    Dashboard
                </a>
                ...
                {{-- Data P2TL (tanpa dropdown admin) --}}
                <a href="{{ route('data.p2tl') }}" class="text-white hover:underline underline-offset-4 decoration-2 decoration-indigo-500 px-3 py-2 text-sm font-medium">
                    Data P2TL
                </a>

                <a href="{{ route('data.realisasi') }}" class="text-white hover:underline underline-offset-4 decoration-2 decoration-indigo-500 px-3 py-2 text-sm font-medium">
                    Realisasi
                </a>
            </div>
